...
"""Tests for WopiSessionEndpoint - direct endpoint tests for coverage.

These tests directly exercise WopiSessionEndpoint methods to cover
...
from genro_wopi.entities.wopi_session.endpoint import WopiSessionEndpoint


@pytest.fixture
def mock_table():
    """Create mock WopiSessionsTable."""
    table = MagicMock()
...
def endpoint(mock_table):
    """Create WopiSessionEndpoint with mock table."""
    return WopiSessionEndpoint(mock_table)


class TestWopiSessionEndpointCreate:
    """Tests for WopiSessionEndpoint.create() method."""
...
class TestWopiSessionEndpointGet:
    """Tests for WopiSessionEndpoint.get() method."""
...
class TestWopiSessionEndpointList:
    """Tests for WopiSessionEndpoint.list() method."""
...
class TestWopiSessionEndpointClose:
    """Tests for WopiSessionEndpoint.close() method."""
...
class TestWopiSessionEndpointCleanup:
    """Tests for WopiSessionEndpoint.cleanup() method."""
