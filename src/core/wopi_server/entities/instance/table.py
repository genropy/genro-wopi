...
Example:
    Basic instance configuration::
        ...
        instance = wopi.db.table("instance")

        # Set instance name
        await instance.set_name("production-wopi")
...
class InstanceTable(Table):
    ...
    Example:
        Configure instance settings::
            ...
            # Typed column access
            await instance.set_name("my-wopi")
    ...
    def configure(self) -> None:
        ...
        Columns:
            ...
            name: Instance display name (default: "wopi-server").
            api_token: Master API token for authentication.
        ...
        c = self.columns
        c.column("id", Integer)
        c.column("name", String, default="wopi-server")
    ...
    async def get_name(self) -> str:
        ...
        Returns:
            Instance name, defaults to "wopi-server" if not set.
        """
        row = await self.ensure_instance()
        return row.get("name") or "wopi-server"
    ...
    async def get_all_config(self) -> dict[str, Any]:
        ...
        Example:
            ::
                ...
                # Returns: {"name": "my-wopi", "edition": "ce", "host": "0.0.0.0", ...}
        """
        row = await self.ensure_instance()
        result: dict[str, Any] = {}
        # Add typed columns
