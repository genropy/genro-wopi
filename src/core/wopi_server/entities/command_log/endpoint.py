...
cli_base modules, which generate FastAPI routes and Click commands
from method signatures.

Example:
    CLI commands auto-generated::

        wopi-server command_log list --tenant-id acme --limit 50
        wopi-server command_log get --command-id 123
        wopi-server command_log export --tenant-id acme
        wopi-server command_log purge --threshold-ts 1700000000
